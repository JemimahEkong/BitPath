          ...
          {!showEmailForm ? (
            ...
            >
              ...
              <p style={{
                ...
                By continuing, you agree to BitPath&apos;s{' '}
                <a href="#" style={{ color: t.accent, textDecoration: 'underline' }}>Terms of Service</a>
                {' '}and{' '}
                <a href="#" style={{ color: t.accent, textDecoration: 'underline' }}>Privacy Policy</a>.
              </p>
