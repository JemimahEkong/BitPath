...
export class RewardsController {
  ...
  @Get('unclaimed/:userId')
  getUnclaimedRewards(@Param('userId') userId: string) {
    return this.lightningService.getUnclaimedRewards(userId);
  }

  @Post('claim-all')
  claimAllRewards(@Body() body: { userId: string }) {
    return this.lightningService.claimAllRewards(body.userId);
  }
}
